...
?>
<div class="com-content-article item-page base <?php echo $this->pageclass_sfx; ?> mb-5" itemscope itemtype="https://schema.org/Article">
    ...
    <?php if ($params->get('show_title')) : ?>
        <div class="page-header" style="background-image: url(<?php echo $images->image_fulltext; ?>);">
            <div class="wrapper">
