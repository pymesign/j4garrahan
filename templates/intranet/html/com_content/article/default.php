...
?>
<div class="com-content-article item-page <?php echo $this->pageclass_sfx; ?> mb-5 main-grid" itemscope itemtype="https://schema.org/Article">
	...
	<?php if (isset($myCustomFields['volanta']) and !empty($myCustomFields['volanta'])) : ?>
		<div class="volanta main-grid-child">
			<?php echo $myCustomFields['volanta']; ?>
		</div>
	<?php endif; ?>

	<?php if ($params->get('show_title')) : ?>
		<div class="titulo-noticia mb-5 main-grid-child">
	...
	<?php if (isset($myCustomFields['copete']) and !empty($myCustomFields['copete'])) : ?>
		<div class="copete mb-5 fs-5 main-grid-child">
	...
	<?php if ($params->get('access-view')) : ?>
		...
		<div itemprop="articleBody" class="com-content-article__body main-grid-child px-5">
