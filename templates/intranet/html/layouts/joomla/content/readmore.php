...
<p class="readmore">
	...
	<?php elseif ($params->get('show_readmore_title', 0) == 0) : ?>
		<a class="link-primary text-uppercase text-decoration-none" href="<?php echo $displayData['link']; ?>" aria-label="<?php echo Text::sprintf('JGLOBAL_READ_MORE_TITLE', $this->escape($item->title)); ?>">
